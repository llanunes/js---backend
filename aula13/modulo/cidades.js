...
// const getCidade = function(){
//    let listaCidades = [];
//    let erro = true

//    cidadesPai.forEach(item => {
//        listaCidades.push (item.sigla)
//        erro = false;
//    })
//    if (erro){
//        return false;
//    } else{
//        return JSON.stringify(listaCidades);
//    }
// }

   const getCidade = function (siglaEstado){
      let listaCidades = []
      let erro = true;
      ...
      cidadesPai.forEach(item => {
         ...
         item.cidades.forEach(nomeCidades => {
            listaCidades.push(nomeCidades.nome)
         })
         erro = false;
      }
     });
